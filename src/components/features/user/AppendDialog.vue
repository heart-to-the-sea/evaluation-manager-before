        ...
        <NGrid :cols="2" :x-gap="16">
          ...
          <NGi>
            <NFormItem label="出生日期" path="birthday">
              <NDatePicker v-model:value="formData.birthday" class="w-full" type="date" clearable />
            </NFormItem>
          </NGi>
          ...
          <NGi>
            <NFormItem label="入职日期" path="entryDate">
              <NDatePicker v-model:value="formData.entryDate" class="w-full" type="date" clearable />
            </NFormItem>
          </NGi>
